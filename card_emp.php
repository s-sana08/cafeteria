...
$employees = []; 
      $sql = "
    SELECT e.id, e.emp_id, e.emp_name, e.two_times_food_allowed,
           e.company_id, e.department_id, e.emp_status,e.created_at,
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"><em> Total Employee</em></li>
							</ol>
						</nav>
					</div>
                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0 text-uppercase">Total Employee</h5>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if(count($employees) > 0) {
                                                ...
                                                foreach($employees as $employee) {
                                                    // Assign badge based on food allowance value
                                                    $foodBadge = '';
                                                    if ($employee['two_times_food_allowed'] == 1) {
                                                        $foodBadge = '<span class="badge bg-success">One Time</span>';
                                                    } elseif ($employee['two_times_food_allowed'] == 2) {
                                                    ...
                                                    echo "<tr>
                                                            ...
                                                            <td>".$foodBadge."</td> 
                                                            <td>".date('d/m/Y h:i A', strtotime($employee['created_at']))."</td>                                                        </tr>";
                                                }
                                            } else {
                                                echo "<tr>
