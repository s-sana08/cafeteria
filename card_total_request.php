...
if ($conn) {
  if ($role == '1') {
    $res = $conn->query("SELECT * FROM employee_request ORDER BY id ASC");
  }
  else
    {
        $res = $conn->query("SELECT * FROM employee_request WHERE vnd_name = '$vnd_name' ORDER BY id ASC");
    }
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"><em> Total Request</em></li>
							</ol>
						</nav>
					</div>
				</div>
                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0 text-uppercase">Total Request</h5>
                            </div>
                                       ...
                                       <tbody>
                                            ...
                                            if(count($requests) > 0) {
                                                ...
                                                foreach($requests as $request) {
                                                    // Check flag correctly on $request['flag']
                                                    if($request['flag'] == 0){
                                                    ...
                                                    echo "<tr>
                                                            <td>".$i++."</td>
                                                            <td>".htmlspecialchars($request['vnd_name'])."</td>
                                                            <td>".htmlspecialchars($request['emp_id'])."</td>
