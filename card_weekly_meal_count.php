...
$current_year_week = date('Y') . '-' . date('W'); // current ISO week
...
if ($role == '1' || '3') {
    ...
    WHERE DATE_FORMAT(DATE_SUB(fe.created_at, INTERVAL 4 HOUR), '%Y-%u') = '$current_year_week'
    ORDER BY fe.id DESC
    ";
} else {
    $sql = "
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"><em> Weekly Meal List</em></li>
							</ol>
						</nav>
					</div>
                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0 text-uppercase">Weekly Meal List</h5>
                            </div>
...
<script>
    ...
    var table = $('#example2').DataTable({
        ...
        [
                {
            extend: 'excel',
                title: 'Weekly Meal Employee List',
            exportOptions: {
