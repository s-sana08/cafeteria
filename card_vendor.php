					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"><em> Total Vendor</em></li>
							</ol>
						</nav>
					</div>
				</div>
                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0 text-uppercase">Total Vendor</h5>
                            </div>
                                            ...
                                            if(count($vendors) > 0) {
                                                ...
                                                foreach($vendors as $vendor) {
                                                    echo "<tr>
                                                            ...
                                                            <td>".htmlspecialchars($vendor['email_id'])."</td>
                                                            <td>".htmlspecialchars($vendor['food_type_name'])."</td>
                                                            <td>".date('d/m/Y h:i A', strtotime($vendor['created_at']))."</td> 
                                                        </tr>";
                                                }
                                            } else {
                                                echo "<tr>
